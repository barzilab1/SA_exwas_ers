...
mod_s = lm(exwas_structural_sum ~ race_black + race_white + ethnicity_hisp + exwas_individual_sum, data=dataset,na.action=na.exclude)
...
mod5 = glmer(paste0("SA_y ~ exwas_individual_sum_reg * exwas_structural_sum_reg + ", paste(cov,collapse = " + ") , " + (1 | site_id_l_br/rel_family_id/src_subject_id)"), family = binomial, data = dataset, nAGQ = 0)


tab_model(mod1, mod2, mod3, mod4, mod5, show.intercept = F, 
