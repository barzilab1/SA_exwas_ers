...
individual_level$exwas_individual_sum_z = scale(individual_level$exwas_individual_sum)
structural_level$exwas_structural_sum_z = scale(structural_level$exwas_structural_sum)
